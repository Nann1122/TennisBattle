 ...
 */
class NetServerWeiXin
{
    private static instance:NetServerWeiXin;
    public static getInstance():NetServerWeiXin
    {
    ...
    private gataHost:string = "192.168.199.250";
