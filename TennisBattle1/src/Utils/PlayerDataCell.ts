 ...
 */
class PlayerDataCell extends eui.Group{
    public constructor(){
        super();
        this.Init();
    }

    public playerdata_rank:eui.Label;
    public playerdata_name:eui.Label;
    public playerdata_score:eui.Label;
    public playerdata_head:eui.Image;
