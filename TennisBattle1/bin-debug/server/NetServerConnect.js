...
var NetServerConnect = (function () {
    ...
    var d = __define,c=NetServerConnect,p=c.prototype;
    NetServerConnect.getInstance = function () {
    ...
    p.ConnectWeiXin = function () {
        console.log("NetServer--WeiXin");
        this.ConnectionGate();
    };
    p.DisConnectWeiXin = function () {
    ...
    return NetServerConnect;
}());
egret.registerClass(NetServerConnect,'NetServerConnect');
